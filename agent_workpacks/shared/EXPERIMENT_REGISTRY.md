...
| H5 | experiment_manager_agent + dev_framework_agent | 规模/难度分桶分析 | E1 full-670 registered artifacts | paper_ready | `experiments/aaai2026/h5_complexity_difficulty_metrics.json`; `experiments/aaai2026/h5_complexity_difficulty_table_draft.md`; operation_count 与 machine_load_ratio 为 solver-semantics derived，total_work_minutes/worker_day_count available，load_ratio 明确不替代 machine_load_ratio；2026-07-15 artifact QA PASS |
| H6 | experiment_manager_agent + qa_repro_agent | verifier case study | 4 个 E1 代表 case | paper_ready | `experiments/aaai2026/h6_verifier_case_study_manifest.json`; `experiments/aaai2026/h6_verifier_case_study_draft.md`; `SO-2025-04-0022-2`, `SO-2022-12-0019-2`, `SO-2024-10-0032-2`, `SO-2025-05-0003-2`; 2026-07-15 provenance 修正后 artifact QA PASS |
| H7 | dev_runner_agent | CP-SAT 600s 附录 | stratified 50，600s/case | paper_ready | `results/raw_view/h7_cpsat_stratified50_tl600_20260715_013325/summary.json`; `experiments/aaai2026/metrics_h7_cpsat_stratified50_tl600_20260715_013325.json`; 50 cases，44 verify ok，6 infeasible_proven，0 unsolved，0 verify invalid；appendix-only，禁止与 E4 120s 或 full-670 等价比较 |
