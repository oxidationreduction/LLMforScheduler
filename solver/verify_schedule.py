...
def verify_solution(order_path: Path, solution_path: Path, *, check_machine_concurrency: bool = True) -> dict[str, Any]:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Verify a solver output under docs/task.md semantics.")
    parser.add_argument("order_json", type=Path)
